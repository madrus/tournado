...
**HIGH (architectural/quality issues):**
4. **RBAC pattern mismatch** - Uses roles instead of permissions
5. **Swap operation not invocable** - Model exists but UI can't trigger it
