    ...
    <div className='safe-bottom bg-accent fixed right-0 bottom-0 left-0 z-40 p-4 shadow-lg'>
      <div className='flex items-center justify-between gap-4'>
        <div className='flex-1'>
          <p className='text-foreground-heading text-sm font-medium'>
            ...
            <div className='relative'>
              {showTopArrow ? (
                <div className='flex flex-col items-center'>
                  <svg
                    className='text-foreground-darker h-6 w-6 animate-bounce'
                    fill='currentColor'
                    viewBox='0 0 24 24'
                  >
                    <path d='M12 2L4.5 20.29l.71.71L12 18l6.79 3 .71-.71z' />
                  </svg>
                  <div className='from-foreground-darker/20 h-16 w-1 bg-gradient-to-b to-transparent' />
                </div>
              ) : null}
              {showMenuDots ? (
                <div className='flex flex-col items-center'>
                  <span className='text-foreground-darker animate-pulse text-lg font-bold'>
                    {promptText[platform].icon}
                  </span>
                  <div className='from-foreground-darker/20 h-16 w-1 bg-gradient-to-t to-transparent' />
                </div>
              ) : null}
            </div>
          </div>
        ...
        <button
          ...
          className='bg-primary text-primary-foreground hover:bg-primary-hover rounded-full p-2'
