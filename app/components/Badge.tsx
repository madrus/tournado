...
const badgeVariants = cva('inline-flex items-center rounded-full px-3 py-0.5 font-medium text-sm', {
	variants: {
		color: {
...
export const Badge = ({ children, color, className }: Readonly<BadgeProps>): JSX.Element => (
