	...
	],
	{
		variants: {
			...
			color: {
				...
				pink: 'border-pink-700/30 hover:border-pink-600 hover:shadow-md hover:shadow-pink-500/20 focus:border-pink-500 focus:ring-4 focus:ring-pink-500/20 dark:focus:ring-pink-400/30 dark:hover:shadow-pink-400/30',
				indigo:
				...
				zinc: 'border-zinc-700/30 hover:border-zinc-600 hover:shadow-md hover:shadow-zinc-500/20 focus:border-zinc-500 focus:ring-4 focus:ring-zinc-500/20 dark:focus:ring-zinc-400/30 dark:hover:shadow-zinc-400/30',
				orange:
					'border-orange-700/30 hover:border-orange-600 hover:shadow-md hover:shadow-orange-500/20 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/20 dark:focus:ring-orange-400/30 dark:hover:shadow-orange-400/30',
				amber:
				...
				violet:
					'border-violet-700/30 hover:border-violet-600 hover:shadow-md hover:shadow-violet-500/20 focus:border-violet-500 focus:ring-4 focus:ring-violet-500/20 dark:focus:ring-violet-400/30 dark:hover:shadow-violet-400/30',
				fuchsia:
				...
				rose: 'border-rose-700/30 hover:border-rose-600 hover:shadow-md hover:shadow-rose-500/20 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/20 dark:focus:ring-rose-400/30 dark:hover:shadow-rose-400/30',
	...
	],
	{
		variants: {
			...
			color: {
				...
				pink: 'border-pink-700/30 hover:border-pink-700/50 hover:shadow-md hover:shadow-pink-500/20 focus:border-pink-500 focus:ring-4 focus:ring-pink-500/20 data-[state=open]:border-pink-500 data-[state=open]:ring-4 data-[state=open]:ring-pink-500/20 dark:focus:ring-pink-400/30 dark:hover:shadow-pink-400/30',
				indigo:
				...
				zinc: 'border-zinc-700/30 hover:border-zinc-700/50 hover:shadow-md hover:shadow-zinc-500/20 focus:border-zinc-500 focus:ring-4 focus:ring-zinc-500/20 data-[state=open]:border-zinc-500 data-[state=open]:ring-4 data-[state=open]:ring-zinc-500/20 dark:focus:ring-zinc-400/30 dark:hover:shadow-zinc-400/30',
				orange:
					'border-orange-700/30 hover:border-orange-700/50 hover:shadow-md hover:shadow-orange-500/20 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/20 data-[state=open]:border-orange-500 data-[state=open]:ring-4 data-[state=open]:ring-orange-500/20 dark:focus:ring-orange-400/30 dark:hover:shadow-orange-400/30',
				amber:
				...
				violet:
					'border-violet-700/30 hover:border-violet-700/50 hover:shadow-md hover:shadow-violet-500/20 focus:border-violet-500 focus:ring-4 focus:ring-violet-500/20 data-[state=open]:border-violet-500 data-[state=open]:ring-4 data-[state=open]:ring-violet-500/20 dark:focus:ring-violet-400/30 dark:hover:shadow-violet-400/30',
				fuchsia:
				...
				rose: 'border-rose-700/30 hover:border-rose-700/50 hover:shadow-md hover:shadow-rose-500/20 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/20 data-[state=open]:border-rose-500 data-[state=open]:ring-4 data-[state=open]:ring-rose-500/20 dark:focus:ring-rose-400/30 dark:hover:shadow-rose-400/30',
				disabled: 'border-slate-200 dark:border-slate-800',
			},
			disabled: {
				true: 'cursor-not-allowed opacity-50',
	...
	['z-50 overflow-hidden rounded-md border shadow-lg', 'border-input-border'],
	{
		variants: {
			color: {
				...
				pink: 'combo-content-bg bg-pink-50 text-pink-800 dark:text-pink-50',
				...
				zinc: 'combo-content-bg bg-zinc-50 text-zinc-800 dark:text-zinc-50',
				orange: 'combo-content-bg bg-orange-50 text-orange-800 dark:text-orange-50',
				...
				violet: 'combo-content-bg bg-violet-50 text-violet-800 dark:text-violet-50',
				fuchsia: 'combo-content-bg bg-fuchsia-50 text-fuchsia-800 dark:text-fuchsia-50',
				rose: 'combo-content-bg bg-rose-50 text-rose-800 dark:text-rose-50',
				disabled:
	...
	],
	{
		variants: {
			...
			color: {
				...
				pink: 'text-pink-800 hover:bg-pink-100 focus:bg-pink-100 data-[highlighted]:bg-pink-100 dark:text-pink-50 dark:data-[highlighted]:bg-pink-900 dark:focus:bg-pink-900 dark:hover:bg-pink-900',
				indigo:
				...
				zinc: 'text-zinc-800 hover:bg-zinc-100 focus:bg-zinc-100 data-[highlighted]:bg-zinc-100 dark:text-zinc-50 dark:data-[highlighted]:bg-zinc-900 dark:focus:bg-zinc-900 dark:hover:bg-zinc-900',
				orange:
					'text-orange-800 hover:bg-orange-100 focus:bg-orange-100 data-[highlighted]:bg-orange-100 dark:text-orange-50 dark:data-[highlighted]:bg-orange-900 dark:focus:bg-orange-900 dark:hover:bg-orange-900',
				amber:
				...
				violet:
					'text-violet-800 hover:bg-violet-100 focus:bg-violet-100 data-[highlighted]:bg-violet-100 dark:text-violet-50 dark:data-[highlighted]:bg-violet-900 dark:focus:bg-violet-900 dark:hover:bg-violet-900',
				fuchsia:
				...
				rose: 'text-rose-800 hover:bg-rose-100 focus:bg-rose-100 data-[highlighted]:bg-rose-100 dark:text-rose-50 dark:data-[highlighted]:bg-rose-900 dark:focus:bg-rose-900 dark:hover:bg-rose-900',
	...
	],
	{
		variants: {
			color: {
				...
				pink: 'border-pink-700/30 checked:border-pink-600 checked:bg-pink-600 hover:border-pink-600 hover:shadow-md hover:shadow-pink-500/20 focus:border-pink-500 focus:ring-4 focus:ring-pink-500/20 dark:focus:ring-pink-400/30 dark:hover:shadow-pink-400/30',
				indigo:
				...
				zinc: 'border-zinc-700/30 checked:border-zinc-600 checked:bg-zinc-600 hover:border-zinc-600 hover:shadow-md hover:shadow-zinc-500/20 focus:border-zinc-500 focus:ring-4 focus:ring-zinc-500/20 dark:focus:ring-zinc-400/30 dark:hover:shadow-zinc-400/30',
				orange:
					'border-orange-700/30 checked:border-orange-600 checked:bg-orange-600 hover:border-orange-600 hover:shadow-md hover:shadow-orange-500/20 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/20 dark:focus:ring-orange-400/30 dark:hover:shadow-orange-400/30',
				amber:
				...
				violet:
					'border-violet-700/30 checked:border-violet-600 checked:bg-violet-600 hover:border-violet-600 hover:shadow-md hover:shadow-violet-500/20 focus:border-violet-500 focus:ring-4 focus:ring-violet-500/20 dark:focus:ring-violet-400/30 dark:hover:shadow-violet-400/30',
				fuchsia:
				...
				rose: 'border-rose-700/30 checked:border-rose-600 checked:bg-rose-600 hover:border-rose-600 hover:shadow-md hover:shadow-rose-500/20 focus:border-rose-500 focus:ring-4 focus:ring-rose-500/20 dark:focus:ring-rose-400/30 dark:hover:shadow-rose-400/30',
				disabled: 'border-slate-200 dark:border-slate-800',
			},
			disabled: {
				true: 'cursor-not-allowed opacity-50',
