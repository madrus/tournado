  ...
  ['relative overflow-visible p-6'],
  {
    variants: {
      ...
      color: createColorVariantMapping(color => {
        ...
        if (color === 'brand') return 'border-brand-400 panel-brand-bg'
        // Primary maps to emerald for design system consistency
        if (color === 'primary') return 'border-emerald-300 panel-emerald-bg'
      ...
      variant: {
        ...
        'dashboard-panel':
          'rounded-xl border shadow-lg p-6 [&_.dashboard-content]:flex [&_.dashboard-content]:items-center [&_.dashboard-icon]:flex-shrink-0 [&_.dashboard-icon]:me-5 [&_.dashboard-stats]:w-0 [&_.dashboard-stats]:flex-1',
        /** Form panels with responsive padding for multi-step forms */
        'form-panel': 'rounded-xl border shadow-lg p-6 lg:p-8',
      },
    },
    defaultVariants: {
      color: 'brand',
