...
export function useTheme(): UseThemeReturn {
	...
	const getThemeColors = (): ThemeColors => ({
		...
		buttonDangerSecondaryHoverBackground: getThemeColor('buttonDangerSecondaryHoverBackground'),
		...
		buttonDangerTertiaryHoverBackground: getThemeColor('buttonDangerTertiaryHoverBackground'),
		...
		buttonBrandSecondaryHoverBackground: getThemeColor('buttonBrandSecondaryHoverBackground'),
		...
		buttonBrandTertiaryHoverBackground: getThemeColor('buttonBrandTertiaryHoverBackground'),
		...
		buttonNeutralSecondaryHoverBackground: getThemeColor('buttonNeutralSecondaryHoverBackground'),
		...
		buttonNeutralTertiaryHoverBackground: getThemeColor('buttonNeutralTertiaryHoverBackground'),
		buttonNeutralTertiaryHoverBorder: getThemeColor('buttonNeutralTertiaryHoverBorder'),
		buttonDangerOutlineFocusRingInner: getThemeColor('buttonDangerOutlineFocusRingInner'),
		buttonDangerOutlineFocusRingOuter: getThemeColor('buttonDangerOutlineFocusRingOuter'),
