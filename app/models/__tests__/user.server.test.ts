...
describe('user.server', () => {
  ...
  describe('updateUserRole', () => {
    it('should update role and create audit log', async () => {
      const currentUser = { id: 'user-123', email: 'test@example.com', role: 'PUBLIC' }
    ...
    it('should short-circuit if role is already the desired value', async () => {
      const currentUser = { id: 'user-123', email: 'test@example.com', role: 'ADMIN' }
  ...
  describe('searchUsers', () => {
    ...
    it('should search users with role filter', async () => {
      ...
      const result = await searchUsers({ query: 'test', role: 'PUBLIC' as Role })
