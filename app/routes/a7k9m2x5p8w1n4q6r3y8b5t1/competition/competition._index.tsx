...
export async function loader({ request, params: _params }: Route.LoaderArgs): Promise<Response> {
	...
	if (tournamentId) {
		return redirect(`/a7k9m2x5p8w1n4q6r3y8b5t1/competition/groups?tournament=${tournamentId}`)
	} else {
