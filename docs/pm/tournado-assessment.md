...
2. **Interview your PM friend** and document their insights
3. **Research competitors** (Claude can help with this)
4. **Pick a feature** to work on
5. **Use the PRD workflow** with your context files
6. **Iterate and build** your knowledge base over time
...
The context files become your "company memory" - they grow over time and make future PRDs easier to write.
