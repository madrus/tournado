...
INSERT INTO "new_Team" ("createdAt", "id", "division", "teamLeaderId", "teamName", "tournamentId", "updatedAt", "clubName") SELECT "createdAt", "id", "division", "teamLeaderId", "teamName", "tournamentId", "updatedAt", "sv DIO" FROM "Team";
DROP TABLE "Team";
