  ...
  plugins: [
    ...
    (hook) => {
      hook.doneEach(() => {
        ...
        const findRoot = () => selectors.map((s) => document.querySelector(s)).find(Boolean)
        const isHomeLink = (li) => !!li.querySelector('a[href="README.md"], a[href="./README.md"], a[href="/README.md"], a[href="index.html"], a[href="./index.html"]')
        ...
        const apply = (root) => {
          ...
          const anyOpen = topLis.some((li) => li.classList && li.classList.contains('open'))
          if (!anyOpen) {
            const firstWith = topLis.find((li) => li.querySelector(':scope > ul') || li.querySelector('ul'))
            if (firstWith) {
              firstWith.classList.add('open')
              const sub = firstWith.querySelector(':scope > ul') || firstWith.querySelector('ul')
